...
To configure the Comet Optimizer, you will have to create a JSON file with the information about the sweep. An example file has been provided in `yolo.utils/loggers/comet/optimizer_config.json`

```shell
python yolo.utils/loggers/comet/hpo.py \
  --comet_optimizer_config "yolo.utils/loggers/comet/optimizer_config.json"
```
...
```shell
comet optimizer -j <set number of workers> yolo.utils/loggers/comet/hpo.py \
  yolo.utils/loggers/comet/optimizer_config.json"
```
